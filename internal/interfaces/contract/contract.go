...
func Build(version string) Contract {
	return Contract{
		...
		Artifacts: []Artifact{
			{
				ID:             artifacts.RunJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       true,
				PathPattern:    ".zcl/runs/<runId>/" + artifacts.RunJSON,
				RequiredFields: []string{"schemaVersion", "artifactLayoutVersion", "runId", "suiteId", "createdAt"},
			},
			{
				ID:             artifacts.SuiteJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/" + artifacts.SuiteJSON,
				RequiredFields: []string{},
			},
			{
				ID:             artifacts.SuiteRunSummaryJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/" + artifacts.SuiteRunSummaryJSON,
			...
			{
				ID:             artifacts.RunReportJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/" + artifacts.RunReportJSON,
				RequiredFields: []string{"schemaVersion", "target", "runId", "suiteId", "path", "attempts", "aggregate"},
			},
			{
				ID:             artifacts.CampaignStateJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.CampaignStateJSON,
				RequiredFields: []string{"schemaVersion", "campaignId", "suiteId", "updatedAt", "latestRunId", "runs"},
			},
			{
				ID:             artifacts.CampaignRunStateJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.CampaignRunStateJSON,
				RequiredFields: []string{"schemaVersion", "campaignId", "runId", "status", "updatedAt", "totalMissions", "missionsCompleted"},
			},
			{
				ID:             artifacts.CampaignPlanJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.CampaignPlanJSON,
				RequiredFields: []string{"schemaVersion", "campaignId", "specPath", "missions", "createdAt", "updatedAt"},
			},
			{
				ID:             artifacts.CampaignProgressJSONL,
				Kind:           "jsonl",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.CampaignProgressJSONL,
				RequiredFields: []string{},
			},
			{
				ID:             artifacts.CampaignReportJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.CampaignReportJSON,
				RequiredFields: []string{"schemaVersion", "campaignId", "runId", "status", "totalMissions", "missionsCompleted", "gatesPassed", "gatesFailed"},
			},
			{
				ID:             artifacts.CampaignSummaryJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.CampaignSummaryJSON,
			...
			{
				ID:             artifacts.CampaignResultsMD,
				Kind:           "text",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.CampaignResultsMD,
				RequiredFields: []string{},
			},
			{
				ID:             artifacts.MissionPromptsJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/campaigns/<campaignId>/" + artifacts.MissionPromptsJSON,
				RequiredFields: []string{"schemaVersion", "campaignId", "specPath", "templatePath", "outPath", "createdAt", "prompts"},
			},
			{
				ID:             artifacts.AttemptJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       true,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.AttemptJSON,
				RequiredFields: []string{"schemaVersion", "runId", "suiteId", "missionId", "attemptId", "mode", "startedAt"},
			},
			{
				ID:             artifacts.PromptTXT,
				Kind:           "text",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.PromptTXT,
				RequiredFields: []string{},
			},
			{
				ID:             artifacts.AttemptEnvSH,
				Kind:           "text",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.AttemptEnvSH,
				RequiredFields: []string{},
			},
			{
				ID:             artifacts.AttemptRuntimeEnvJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.AttemptRuntimeEnvJSON,
				RequiredFields: []string{"schemaVersion", "runId", "suiteId", "missionId", "attemptId", "createdAt", "runtime", "prompt", "env"},
			},
			{
				ID:              artifacts.ToolCallsJSONL,
				Kind:            "jsonl",
				SchemaVersions:  []int{1},
				Required:        false,
				RequiredInModes: []string{"discovery", "ci"},
				PathPattern:     ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.ToolCallsJSONL,
				RequiredFields:  []string{},
			},
			{
				ID:              artifacts.FeedbackJSON,
				Kind:            "json",
				SchemaVersions:  []int{1},
				Required:        false,
				RequiredInModes: []string{"discovery", "ci"},
				PathPattern:     ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.FeedbackJSON,
				RequiredFields:  []string{"schemaVersion", "runId", "suiteId", "missionId", "attemptId", "ok", "createdAt"},
			},
			{
				ID:             artifacts.NotesJSONL,
				Kind:           "jsonl",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.NotesJSONL,
				RequiredFields: []string{},
			},
			{
				ID:             artifacts.CapturesJSONL,
				Kind:           "jsonl",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.CapturesJSONL,
				RequiredFields: []string{},
			},
			{
				ID:             artifacts.AttemptReportJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.AttemptReportJSON,
				RequiredFields: []string{"schemaVersion", "runId", "suiteId", "missionId", "attemptId", "computedAt", "metrics", "artifacts"},
			},
			{
				ID:             artifacts.OracleVerdictJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.OracleVerdictJSON,
			...
			{
				ID:             artifacts.RunnerRefJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.RunnerRefJSON,
				RequiredFields: []string{"schemaVersion", "runner", "runId", "suiteId", "missionId", "attemptId"},
			},
			{
				ID:             artifacts.RunnerMetricsJSON,
				Kind:           "json",
				SchemaVersions: []int{1},
				Required:       false,
				PathPattern:    ".zcl/runs/<runId>/attempts/<attemptId>/" + artifacts.RunnerMetricsJSON,
				RequiredFields: []string{"schemaVersion", "runner"},
			},
		},
		Events: []Event{
			{
				Stream:         artifacts.ToolCallsJSONL,
				SchemaVersions: []int{1},
				RequiredFields: []string{"v", "ts", "runId", "missionId", "attemptId", "tool", "op", "result", "io"},
			},
			{
				Stream:         artifacts.NotesJSONL,
				SchemaVersions: []int{1},
				RequiredFields: []string{"v", "ts", "runId", "missionId", "attemptId", "kind"},
			},
			{
				Stream:         artifacts.CapturesJSONL,
				SchemaVersions: []int{1},
		...
		Commands: []Command{
			...
			{
				ID:      "enrich",
				Usage:   "zcl enrich --runner " + runnerid.CLIUsageValues() + " --rollout <rollout.jsonl> [<attemptDir>]",
